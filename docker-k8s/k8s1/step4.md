...
`kubectl get deployments`{{exec}} 를 통해 생성된 Deployment 를 확인할 수 있으며, `kubectl get replicasets`{{exec}} 를 통해 생성된 ReplicaSet을 확인할 수 있고, `kubectl get pods`{{exec}} 를 통해 10개의 Pod가 생성된 것을 확인할 수 있습니다.
